import {
  ...
  HOOKS
} from "./chunk-LLXXG735.js";
import {
  useNpsSurveySettings
} from "./chunk-3HH5LN23.js";
import {
  GuidedTourContext,
  useAIAvailability
} from "./chunk-GTOLEENN.js";
import {
  useGetAIUsageQuery
} from "./chunk-YLLOHDRI.js";
import {
  require_pick
} from "./chunk-3PKQCIXB.js";
import {
  getBasename
} from "./chunk-QIJGNK42.js";
import {
  useClipboard
} from "./chunk-PQL5LDTS.js";
import {
  useEnterprise
} from "./chunk-CRNSHUTA.js";
import {
  ADMIN_PERMISSIONS_EE,
  AUDIT_LOGS_DEFAULT_PAGE_SIZE,
  getEERoutes
} from "./chunk-JJTWXAX6.js";
import {
  Login
} from "./chunk-EJUXLMSE.js";
import {
  MemoizedInputRenderer
} from "./chunk-P24LRLXL.js";
import {
  Form
} from "./chunk-KVXPOTMV.js";
import {
  Column,
  LayoutContent,
  Logo,
  UnauthenticatedLayout
} from "./chunk-C3GFAVNY.js";
import {
  ConfigurationProvider
} from "./chunk-IL2LWZVV.js";
import {
  _setPrototypeOf
...
import {
  ...
  require_merge,
  require_omit
} from "./chunk-QTIFUUOF.js";
import {
  require_baseRest
} from "./chunk-P36M6HGY.js";
import {
  HistoryProvider
} from "./chunk-XERNU2DK.js";
import {
  errorsTrads
...
import {
  ...
  create4 as create2,
  create6 as create3
} from "./chunk-OX2BEJD2.js";
import {
  Layouts
} from "./chunk-I4JVYEYL.js";
import {
  TrackingProvider,
  useTracking
} from "./chunk-GBSNCCNX.js";
import {
  createAbsoluteUrl,
  useInitQuery
} from "./chunk-IQSPJ2Q6.js";
import {
  getByteSize
...
} from "./chunk-HPH7JNKX.js";
import {
  useTypedDispatch,
  useTypedSelector,
  useTypedStore
} from "./chunk-GYGAWPYS.js";
import {
  NotificationsProvider,
  useNotification
} from "./chunk-JN5KUEAA.js";
import {
...
import {
  ...
  useIntl,
  zn
} from "./chunk-RC24IJED.js";
import {
  require_client
} from "./chunk-GMEE6XVY.js";
import {
  Link,
  NavLink,
  Navigate,
  ...
  useNavigate,
  useRouteError
} from "./chunk-VMUOQSJK.js";
import {
  require_react_dom
} from "./chunk-OT6VATTC.js";
import {
  $5,
  Dn,
  E2,
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-4VKH3G7F.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-R3QHSUUX.js");
        return {
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-IFUG3ZZQ.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-XEIOCRGP.js")).FORMS, {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-IBPCQFNG.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-U7HZY4QM.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-NJZZDZ4L.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-TBFVHHWM.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-BI7N5JRP.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-OAAGOFDK.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-UV4LWJXD.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-LACK6RIW.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-IIZJMO4K.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-5YI54M4W.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-UVEZO3NZ.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-KG2YK7EF.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-AWKIFWC4.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-IYL3IC2W.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-HXXVDIPZ.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-NVMVXL6I.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-5DTP3JNH.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-JMO6R4NF.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-5PGFYNRY.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-V72RLHA3.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-Y3L3RDD6.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-GMRU526G.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-WPG2XNMD.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-T2ZX2MMP.js");
              return {
    ...
    this.widgets.register([
      {
        ...
        component: async () => {
          const { ProfileWidget } = await import("./Widgets-VPET255A.js");
      ...
      },
      {
        ...
        component: async () => {
          const { KeyStatisticsWidget } = await import("./Widgets-VPET255A.js");
      ...
      this.widgets.register([
        {
          ...
          component: async () => {
            const { AuditLogsWidget } = await import("./Widgets-ZCQQFY3L.js");
...
//# sourceMappingURL=chunk-RPELVJB3.js.map
